        ...
        <div className="px-4 py-6 sm:px-0">
            ...
            <div className="bg-white shadow rounded-lg p-4 sm:p-6 mb-8">
                ...
                <div className="grid grid-cols-1 gap-4">
                    <a
                        href="/salad-builder"
                        className="relative rounded-lg border border-gray-300 bg-white px-4 sm:px-6 py-4 sm:py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-orange-500"
                    >
                        <div className="flex-shrink-0">
                            <Salad className="h-8 w-8 sm:h-10 sm:w-10 text-orange-600" />
                        </div>
