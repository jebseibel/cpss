...
1. `CustomerMapper.java` - `com.seibel.cpss.database.db.mapper`
2. `CustomerRepository.java` - `com.seibel.cpss.database.db.repository`
3. `CustomerDbService.java` - `com.seibel.cpss.database.db.service`
4. `CustomerService.java` - `com.seibel.cpss.service`
5. `RequestCustomerCreate.java` - `com.seibel.cpss.web.request`
6. `RequestCustomerUpdate.java` - `com.seibel.cpss.web.request`
7. `ResponseCustomer.java` - `com.seibel.cpss.web.response`
8. `CustomerController.java` - `com.seibel.cpss.web.controller`
9. `CustomerConverter.java` - `com.seibel.cpss.web.converter`
...
- `{Entity}Service.java` - Business logic layer
    ...
    - **Import required:** `import com.seibel.cpss.database.exceptions.DatabaseFailureException;`
...
### 9. **Controller** (`com.seibel.cpss.app.web.controller`)
...
### 10. **Converter** (`com.seibel.cpss.app.web.converter`)
